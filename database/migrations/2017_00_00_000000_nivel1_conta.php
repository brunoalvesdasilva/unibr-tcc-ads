...
class Nivel1Conta extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('conta', function (Blueprint $table) {
            ...
            $table->float('vl_inicial_conta', 8,2)->comment('Valor inicial da conta, obs: representa o quanto aquela conta ja possui');
            $table->float('vl_atual_conta', 8,2)->comment('Valor atual da conta, obs:representa o valor alterado referente as movimentacoes');
